...
prun -np 8 /home/bbkruit/spark-2.4.0-bin-without-hadoop/bin/spark-submit --driver-memory 8G --executor-memory 8G --num-executors 8  test.py $ES_NODE:$ES_PORT $KB_NODE:$KB_PORT
